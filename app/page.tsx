export default function Home() {
  const faqs = [
    ...
    {
      q: 'How are changelogs generated?',
      a: 'SchemaLog diffs your schema snapshots and uses AI to produce plain-English migration notes your whole team can understand.'
    },
    {
      q: 'Can I export or share changelogs?',
      a: 'Yes. Every changelog can be exported as Markdown or PDF and shared via a public link or emailed to stakeholders automatically.'
    }
  ]
    ...
    <main className="min-h-screen bg-[#0d1117] text-[#c9d1d9]">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-24 pb-20 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight mb-5">
          ...
          <span className="text-[#58a6ff]">migration changelogs</span>
        </h1>
        <p className="text-lg text-[#8b949e] max-w-xl mx-auto mb-8">
          SchemaLog monitors your database schema changes and instantly produces human-readable changelogs — so your team and stakeholders always know what changed and why.
        </p>
        <a
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
          {[
            { icon: '🔍', title: 'Schema Monitoring', desc: 'Polls or listens via webhooks for any DDL change across your databases.' },
            { icon: '✍️', title: 'AI-Written Changelogs', desc: 'Converts raw diffs into clear, stakeholder-friendly Markdown notes.' },
            { icon: '📬', title: 'Stakeholder Notifications', desc: 'Emails or Slack alerts sent automatically when a new changelog is ready.' }
          ].map(f => (
      ...
      <footer className="border-t border-[#21262d] text-center py-8 text-xs text-[#6e7681]">
        © {new Date().getFullYear()} SchemaLog. Built for development teams.
      </footer>
    </main>
  )
}
